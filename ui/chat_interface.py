...
class ModernChatInterface(MDScreen):
    ...
    def start_logo_animation(self):
        ...
        def pulse_logo(dt):
            pulse = Animation(scale_x=1.1, scale_y=1.1, duration=2.0, t='in_out_sine')
            pulse += Animation(scale_x=1.0, scale_y=1.0, duration=2.0, t='in_out_sine')
            pulse.start(self.app_logo)
            Clock.schedule_once(pulse_logo, 4.0)
        
        Clock.schedule_once(pulse_logo, 1.0)
